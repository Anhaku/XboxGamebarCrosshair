...
namespace XboxGamebarCrosshair
{
    ...
    {
        private XboxGameBarWidget m_widget = null;
        /// <summary>
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            if (widgetArgs != null)
            {
                if (widgetArgs.IsLaunchActivation)
                {
                    ...
                    if (widgetArgs.AppExtensionId == "XboxGamebarCrosshair")
                    {
                        // This is the parent widget activation.
                        m_widget = new XboxGameBarWidget(
                            widgetArgs,
                            Window.Current.CoreWindow,
                            rootFrame);
                        rootFrame.Navigate(typeof(MainPage), m_widget);
